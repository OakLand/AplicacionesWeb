    ...
    <div style="text-align: center">
        ...
        <asp:ListView ID="ListView1" runat="server" DataSourceID="sqlEventos" GroupItemCount="2">
            ...
            <SelectedItemTemplate>
                <td id="Td2" runat="server" style="background-color: #FFCC66;font-weight: bold;color: #000080;">Promotor:
        ...
        <br />
        <asp:SqlDataSource ID="sqlEventos" runat="server" ConnectionString="<%$ ConnectionStrings:DataBase %>" SelectCommand="SELECT p.Nombre AS Promotor, e.Descripcion, e.Ubicacion, e.Fecha, e.Hora, c.Nombre AS Categoría, e.Reservar, e.Tiempo_Reserva, e.Nombre, i.Imagen, e.Id FROM Evento AS e INNER JOIN Persona AS p ON e.Id_Persona = p.Id INNER JOIN Categoria AS c ON e.Categoria = c.Id INNER JOIN Imagenes AS i ON e.Id = i.Id WHERE (c.Id = @Id) OR (c.Categoria_Padre = @Id)">
        <SelectParameters>
            <asp:CookieParameter CookieName="category" DefaultValue="" Name="Id" Type="Int32" />
        </SelectParameters>
        </asp:SqlDataSource>
